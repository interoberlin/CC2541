...
// *************************** CC2545 ********************************
  ...
  #define PERCFG_U0CFG                      (0x03)        // USART0 I/O location bit mask
    #define PERCFG_U0CFG_ALT1                 (0x00)        // Alternative 1 location
    #define PERCFG_U0CFG_ALT2                 (0x01)        // Alternative 2 location
    #define PERCFG_U0CFG_ALT3                 (0x02)        // Alternative 3 location (this location is not for USART 0 !!!)
...
// U1DBUF (0xF9) - USART 0 Receive/Transmit Data Buffer

// U1BAUD (0xFA) - USART 0 Baud Rate Control
